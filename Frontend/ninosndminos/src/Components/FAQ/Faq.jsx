        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
          <div class="accordion-item">
            <h2 class="accordion-header">
              ...
              >
                Is it necessary to have an account to proceed with?
              </button>
            </h2>
            <div
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button
                ...
                aria-controls="flush-collapseTwo"
              >
                If a customer wants to cancel the order / replace the order?
              </button>
            </h2>
            <div
              id="flush-collapseTwo"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button
                ...
                aria-controls="flush-collapseThree"
              >
                What if incorrect order / damaged product is delivered?
              </button>
            </h2>
            <div
              id="flush-collapseThree"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button
                ...
                aria-controls="flush-collapseTwo"
              >
                What are the payment methods availed by costumer?
              </button>
            </h2>
            <div
              id="flush-collapseTwo"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button
                ...
                aria-controls="flush-collapseThree"
              >
                What is the maximum amount for which the order can be placed?
              </button>
            </h2>
            <div
              id="flush-collapseThree"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header">
              <button
                ...
                aria-controls="flush-collapseTwo"
              >
                What is the duration of delivery time?
              </button>
            </h2>
            <div
              id="flush-collapseTwo"
